...
describe('Slider', () => {
  ...
  it('init OK', () => {
    ...
    expect(markup.querySelectorAll('.yt-entries > div > .yt-entry').length).toBe(3);
  })
  ...
  it('Empty config', () => {
    ...
    expect(markup.querySelectorAll('.yt-entries > div > .yt-entry').length).toBe(2);
  })
  ...
  it('Wrong selector', () => {
    ...
    expect(() => {new Slider('.wrong_selector')})
    ...
    expect(markup.querySelectorAll('.yt-entries > div > .yt-entry').length).toBe(0);
  })
  ...
  it('Wrong wrapper', () => {
    ...
    expect(() => {new Slider(markup)}).not.toThrow();
    expect(markup.querySelector('.yt-arrow-down')).toBeFalsy();
  ...
  it('Slide down after click', () => {
    ...
    expect(() => {new Slider(markup, {visible: 2})}).not.toThrow();
    expect(markup.querySelector('.yt-arrow-down')).toBeTruthy();
    expect(markup.querySelectorAll('.yt-entries > .yt-entry').length).toBe(2);
    expect(markup.querySelectorAll('.yt-entries > div > .yt-entry').length).toBe(3);
